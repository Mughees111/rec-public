...
const Wallet = ({navigation, route}) => {
  const [walletDetails, setWalletDetails] = React.useState({
    ...
    rec_rate: route.params.wallet.rec_rate,
  });
    ...
    return (
      <View
        ...
        <View style={{alignItems: 'center', justifyContent: 'center'}}>
          <Text style={{fontSize: 18}}>{walletDetails.description} Wallet</Text>
        </View>
        <View style={{alignItems: 'center', justifyContent: 'center'}}>
          <TouchableOpacity
            style={{
          ...
          <View
              ...
              <LinearGradient
                ...
                <View
                  ...
                  <View style={{flexDirection: 'column'}}>
                    ...
                    {(() => {
                      if (walletDetails.description == 'REC') {
                        return (
                          <View
                            style={{
                              marginTop: 40,
                            ...
                            <TouchableOpacity
                              onPress={() => {
                                navigation.navigate('BuyRecWallets', {
                                  wallet: walletDetails,
                                });
                              }}>
                              <Text>Buy REC Asset</Text>
                            </TouchableOpacity>
                          </View>
                        );
                      }
            ...
            <View
              ...
              <TouchableOpacity
                ...
                onPress={() =>
                  navigation.navigate('Send', {wallet: walletDetails})
                }>
                <View
                  style={{
              ...
              <TouchableOpacity
                style={{marginTop: 5}}
                onPress={() => {
                    navigation.navigate('Receive', {wallet: walletDetails});
                  }
                }>
                <LinearGradient
                  colors={[COLORS.startGreen, COLORS.endGreen]}
                  style={{
                    borderRadius: 20,
                  }}>
                  <View
